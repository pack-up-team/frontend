...
const Header = ({ pageType = 'default', notificationCount }: HeaderProps) => {
    ...
    */
    ...
    return (
        <header className='w-full flex h-[76px] px-4 py-2 justify-between items-center flex-shrink-0 border-b border-[#F0F0F0] bg-white tablet:h-[84px] tablet:px-[60px] web:px-[120px]'>
