            ...
            <div className="flex flex-col items-end gap-4 self-stretch">
                <div className="flex flex-col items-start gap-2 self-stretch">
                    ...
                    <input
                        ...
                        onChange={(e) => setItemLabel(selectedItemId, e.target.value)}
                ...
                <div className="flex justify-end">
                    <Button disabled={!labelValue} onClick={() => setItemLabel(selectedItemId, "")} variant="line" className="w-[120px] h-[38px] !p-0 text-[#D90050]">삭제</Button>
                </div>
            </div>
        </div>
    );
