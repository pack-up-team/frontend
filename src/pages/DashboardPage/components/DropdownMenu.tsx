    ...
    return (
        <div className="inline-flex px-[16px] py-[12px] items-center rounded-[8px] bg-white shadow-[0_0_16px_0_rgba(0,0,0,0.12)]">
            <ul className="flex flex-col items-start gap-[12px]">
                <li onClick={onRename} className="flex h-[36px] justify-center items-center gap-[8px]">
                ...
                <li onClick={onEdit} className="flex h-[36px] justify-center items-center gap-[8px]">
                ...
                <li onClick={onDuplicate} className="flex h-[36px] justify-center items-center gap-[8px]">
                ...
                <li onClick={onDelete} className="flex h-[36px] justify-center items-center gap-[8px]">
